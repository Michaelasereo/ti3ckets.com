...
export default function OrganizerSettingsMenu() {
  ...
  const isActive = (href: string) => {
    if (href === '/organizer/settings') {
      return pathname === href || pathname?.startsWith('/organizer/settings');
    }
  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center justify-center w-10 h-10 text-primary-800 hover:bg-primary-100 rounded-lg transition"
